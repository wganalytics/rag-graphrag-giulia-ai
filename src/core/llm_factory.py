"""
Fábrica de LLMs multi-provider do GraphRAG.

Único ponto do projeto que sabe qual classe concreta de chat model instanciar.
O motor de grafo (graph_engine) pede um LLM e recebe um BaseChatModel pronto,
sem conhecer Ollama, Gemini ou Grok.
...
# ENGINE_MODEL_NAME é mantido no Ollama por retrocompatibilidade com o .env antigo.
MODEL_ENV_VARS = {
    OLLAMA: ("OLLAMA_MODEL_NAME", "ENGINE_MODEL_NAME"),
